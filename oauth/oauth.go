...
import (
	"encoding/json"
	"fmt"
	"github.com/Narachii/bookstore_oauth-go/oauth/errors"
...
func AuthenticateRequest(request *http.Request) *errors.RestErr {
	...
	// http://api.bookstore.com/resource?access_token=123
...
func getAccessToken(accessTokenId string) (*accessToken, *errors.RestErr) {
	response := oauthRestClient.Get(fmt.Sprintf("/oauth/acess_token/%s", accessTokenId))
